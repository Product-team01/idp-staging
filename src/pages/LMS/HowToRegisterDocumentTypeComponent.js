...
const HowToRegisterDocumentTypeComponent = () => {
  return (
    <div>
      ...
      <h3>Upload</h3>
      <img src="https://d1r1e7xjkfj7nz.cloudfront.net/type7.png" alt="Upload" title="Upload" />
      ...
      <ul>
        ...
        <img src="https://d1r1e7xjkfj7nz.cloudfront.net/type9.png" alt="Upload Document" title="Upload Document" />
      ...
      <ul>
        ...
        <img src="https://d1r1e7xjkfj7nz.cloudfront.net/righttabledt.png" alt="Taxonomy" title="Taxonomy" />
        ...
        <img src="https://d1r1e7xjkfj7nz.cloudfront.net/annotatedt.png" alt="Annotate" title="Annotate" />
        ...
        <img src="https://d1r1e7xjkfj7nz.cloudfront.net/righttabledt.png" alt="Edit Attribute" title="Edit Attribute" />
        ...
        <img src="https://d1r1e7xjkfj7nz.cloudfront.net/dt5.png" alt="View Table Extractions" title="View Table Extractions" />
      </ul>
      ...
      <img src="https://d1r1e7xjkfj7nz.cloudfront.net/registerdt.png" alt="Register" title="Register" />
    </div>
  );
};
