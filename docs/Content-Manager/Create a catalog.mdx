...
<head>
  ...
  <meta name="description" content="Content Hub enables you to create and manage different types of catalogs by ingesting data from various data sources, processing these, and making them available for applications." />
</head>
...
<div className="image-container">
  <img src="https://d1r1e7xjkfj7nz.cloudfront.net/contenthome2b.png" alt="Create a Catalog" title="Create a Catalog" />
</div>
...
4. Select a Segment for the Catalog.
...
- Segment type determines the attributes available to be mapped in 'Map Fields' step.
- It also enables Vue to automatically extract attributes according to the segment type. The default extraction of attributes is only supported if the catalog type is product catalog and the segment type is fashion.

**Note:** You can save your Catalog configuration anytime by clicking on “**Continue Later**” CTA & clicking on “**Save & Exit**”. The Catalog is displayed on the listing screen in a draft state. (Partially filled details are not saved).

## Configure a Connector

<div className="image-container">
  <img src="https://d1r1e7xjkfj7nz.cloudfront.net/catalog3bb.png" alt="Configure a Connector" title="Configure a Connector" />
</div>
...
2. Choose an Upload method type from the dropdown

**Note:** Depending on the upload method type selected, the corresponding configuration fields will be displayed.

3. Fill all the mandatory fields for the selected upload method type
...
<div className="image-container">
  <img src="https://d1r1e7xjkfj7nz.cloudfront.net/catalogsync2.png" alt="Set up sync settings" title="Set up sync settings" />
</div>
...
2. Select a ‘Sync Mode’
   - Full - All the records sent via the connector is processed and existing records in catalog is overwritten.
   - Incremental - Existing records in catalog details are updated with new records details. Any new record is simply added to the catalog as a new record.
3. Select a ‘Sync Frequency’
   - Once Every Few Minutes - configure the minute at which the connector should be synced
   - Once Every Few Hours - configure the hours interval, time & time zone at which the connector should be synced
   - Once A Day - configure the day, time & time zone at which the connector should be synced
   - Weekly - configure the day(s) of the week, time & time zone at which the connector should be synced
   - Once A Month - configure the date of the month, time & time zone at which the connector should be synced
   - Yearly - configure the months(s) in the year, date, time & time zone at which the connector should be synced

**Note:** Depending on the ‘Sync Frequency’ option selected, the corresponding configuration fields will be displayed.

4. Configure all the required fields, to finish setting up Sync for the Catalog
...
<div className="image-container">
  <img src="https://d1r1e7xjkfj7nz.cloudfront.net/catalog4bb.png" alt="Map Fields" title="Map Fields" />
</div>
...
2. Choose the field that you would like to set as the primary key
...
1. Enter the Upload Method Name for the connector
2. Choose the SFTP as the Upload method type from the dropdown
...
1. Enter the Upload Method Name for the connector
2. Choose the Manual as the Upload method type from the dropdown
