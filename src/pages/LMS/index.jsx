...
//       setVideoData({ videoId: '', title: content.title, description: '' });
//       setCurrentComponent(content.children.map((child, i) => (
//         <div key={i}>
//           <h3>{child.title}</h3>
//           {child.component}
//         </div>
...
//                       <div key={i} className="unique-subsection">
//                         <div className={`unique-section-header ${activeTab === `${index}-${i}` ? 'active-tab' : ''}`} onClick={() => loadContentByType(child, index)}>
//                           {child.title}
//                         </div>
//                       </div>
//                     ))}
